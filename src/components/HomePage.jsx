        ...
        <div className='bg-white'>
            ...
            <Link to="https://www.linkedin.com/games/tango/" className='text-black text-decoration-none'>
                <div className="content">
                    <Image src='https://static.licdn.com/aero-v1/sc/h/gqavqd9gk6ja1s27lr1p2zz2' width={30} />
            ...
            <Link to="https://www.linkedin.com/games/tango/" className="text-black text-decoration-none">
                <div className="content">
                    <Image src="https://static.licdn.com/aero-v1/sc/h/6uvsjtqx2j32uh1a803qygh5y" width={30} />
                    <div className="text-container">
