            ...
            <Row className="">
              <Col xs={2}>
                <div className="position-relative">
                  ...
                  {profilePictureEdit && <ProfileModalPhoto 
                                          profilo={props.profilo} 
                                          userId={props.profilo?._id}  // Usa optional chaining per sicurezza
                                          profileEdit={profilePictureEdit}  // Deve ricevere lo stato, non true
                                          setProfilePictureEdit={setProfilePictureEdit}  // Solo la funzione di aggiornamento
                  />}
